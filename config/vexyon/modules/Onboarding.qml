...
PanelWindow {
    ...
    // Monitor con el foco al crearse el splash. Asignación de una sola vez (no
    // binding): en el primer arranque el usuario está donde está, y el splash
    // no debe seguir al ratón mientras lo lee.
    property string scrName: ""
    Component.onCompleted: win.scrName = Panels.focusedScreenName()
