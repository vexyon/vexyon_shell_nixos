                ...
                RowLayout {
                    ...
                    IconButton {
                        ...
                        onClicked: vm.ask2(I18n.t("Import a VM definition"),
                            ...
                            [ { key: "path", label: I18n.t("Path to the .xml file"),
                    ...
                    ColumnLayout {
                        ...
                        Flow {
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    required property var modelData
                                    readonly property bool on: vm.tab === modelData.key
                                    implicitWidth: tTxt.implicitWidth + 20
                                    implicitHeight: 28
                                    radius: Theme.radius
                                    ...
                                    MouseArea {
                                        ...
                                        anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                        onClicked: {
                                            vm.tab = modelData.key;
                                            if (modelData.key === "snapshots") Vm.snapshots_(vm.selected);
                                        }
                                    }
                                }
                            }
                                ...
                                ColumnLayout {
                                    ...
                                    Flow {
                                        ...
                                        ActBtn {
                                            ...
                                            onClicked: vm.ask2(I18n.t("Attach an existing image"),
                                                ...
                                                [ { key: "path", label: I18n.t("Path to the image"), value: "" },
                                                  { key: "bus",  label: I18n.t("Bus (virtio / sata / scsi)"), value: "virtio" } ],
                                                I18n.t("Attach"),
                                                ...
                                                Flow {
                                                    ...
                                                    ActBtn {
                                                        ...
                                                        onClicked: vm.ask2(I18n.t("Insert an ISO"), "",
                                                            [ { key: "iso", label: I18n.t("Path to an .iso file"), value: "" } ],
                                                            I18n.t("Insert"),
                                    ...
                                    ActBtn {
                                        ...
                                        onClicked: vm.ask2(I18n.t("Add an optical drive"),
                                            ...
                                            [ { key: "iso", label: I18n.t("Path to an .iso file (optional)"), value: "" } ],
                                            I18n.t("Add"),
                                ...
                                ColumnLayout {
                                    ...
                                    ActBtn {
                                        ...
                                        onClicked: vm.ask2(I18n.t("Share a folder with the guest"),
                                            ...
                                            [ { key: "path", label: I18n.t("Folder on this computer"), value: Quickshell.env("HOME") },
            ...
            Card {
                ...
                Flickable {
                    ...
                    ColumnLayout {
                        ...
                        Field { id: cIso; label: I18n.t("Path to an .iso file"); placeholder: "/home/…/linux.iso" }
