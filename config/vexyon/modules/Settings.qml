        ...
        Component {
            ...
            Flickable {
                ...
                ColumnLayout {
                    ...
                    // Cursor. Solo dos opciones a propósito: no es un selector
                    // de temas, es "el bonito" o "el de siempre". Lo aplica el
                    // bridge (hl.env en el generado + `hyprctl setcursor` para
                    // que se vea sin cerrar sesión) y viaja también al greeter,
                    // igual que el tema de colores.
                    SsHeader { text: I18n.t("CURSOR") }
                    DropSelect {
                        label: I18n.t("Cursor theme")
                        options: [
                            { v: "pretty", l: I18n.t("Pretty (white)") },
                            { v: "system", l: I18n.t("Default") }
                        ]
