...
PanelWindow {
    ...
    // Sin `python3` delante: en NixOS el helper del store es un wrapper de bash
    // (wrapProgram) y `python3 <wrapper>` fallaba con SyntaxError. Ejecutarlo
    // por su shebang vale en Arch y en NixOS.
    Process {
        id: genPrev
        command: [Wallpaper.genBin]
