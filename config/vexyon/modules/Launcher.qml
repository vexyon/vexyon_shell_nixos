...
PanelWindow {
    id: win
    // Monitor con el foco al abrir (Panels lo fija en toggle/open). Sin esto
    // Quickshell coloca la ventana en la pantalla por defecto — el primer
    // output que enumera el compositor — y el launcher salía siempre ahí.
